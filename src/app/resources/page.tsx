              ...
              <>
                <div className="hidden overflow-x-auto md:block">
                  <table className="w-full min-w-[1216px] table-fixed text-sm">
                    <colgroup><col className="w-56" /><col className="w-24" /><col className="w-72" /><col className="w-48" /><col className="w-24" /><col className="w-32" /><col className="w-48" /></colgroup>
